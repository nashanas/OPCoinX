...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"opcx", "initmasternode", &initmasternode, true, true, false},
        {"opcx", "masternodeisinit", &masternodeisinit, true, true, false},
        {"opcx", "killmasternode", &killmasternode, true, true, false},
