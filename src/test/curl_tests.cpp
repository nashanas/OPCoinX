...
{
    string err1, out1;
    BOOST_CHECK(CURLGetRedirect("https://github.com/OPCoinX/OPCoinX/releases/latest", out1, err1));
...
{
    const CUrl url = "https://github.com/OPCoinX/OPCoinX/releases/download/v1.1.0_qt_downgrade/opcx-1.1.0.tar.gz";
